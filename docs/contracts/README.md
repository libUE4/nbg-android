...
| `task-completion-evidence-contract` | P0 active | Require structured proof or explicit override before task completion claims. | `NbgTaskCompletionEvidence.kt`, `NbgAgentMessageUi.kt`, `HanakoBridge.kt` |
